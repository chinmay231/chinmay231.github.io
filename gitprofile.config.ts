...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['chinmay231/Compio','chinmay231/CodeManager','chinmay231/FUSTT','chinmay231/Fraud_detection_ML'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
  ...
  resume: {
    fileUrl:
      'https://github.com/chinmay231/chinmay231.github.io/blob/main/AI8_25.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Python',
    'SQL',
